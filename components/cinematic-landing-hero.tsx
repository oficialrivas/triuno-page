...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background:
          radial-gradient(ellipse at top center, rgba(215, 80, 18, 0.16), transparent 44%),
          radial-gradient(circle at 50% 52%, rgba(96, 26, 6, 0.12), transparent 52%),
          linear-gradient(180deg, rgba(12, 3, 0, 0.18), rgba(0, 0, 0, 0.28));
      backdrop-filter: blur(18px) saturate(110%);
      -webkit-backdrop-filter: blur(18px) saturate(110%);
      box-shadow: 
          0 34px 110px -55px rgba(215, 80, 18, 0.24),
          0 28px 90px -55px rgba(0, 0, 0, 0.95),
          inset 0 1px 0 rgba(255, 255, 255, 0.045);
      border: 1px solid rgba(215, 80, 18, 0.08);
      position: relative;
  }
  ...
  .premium-depth-card::before {
      ...
      z-index: 1;
      background:
          radial-gradient(circle at 30% 20%, rgba(215,80,18,0.08), transparent 42%),
  ...
  .card-sheen {
      ...
      background: radial-gradient(900px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(215,80,18,0.08) 0%, transparent 45%);
...
export function CinematicHero({ 
  brandName = "Triuno",
  cardHeading = "Arquitectura digital para escalar con seguridad.",
  cardDescription = <><span className="text-white font-semibold">Triuno</span> dise&ntilde;a productos digitales, infraestructura cloud y sistemas de automatizaci&oacute;n para empresas que necesitan crecer sin perder control operativo.</>,
  metricValue = 50,
  metricLabel = "Proyectos",
  ctaHeading = "Conversemos sobre tu proyecto.",
  ctaDescription = "Agenda una evaluaci&oacute;n estrat&eacute;gica y descubre c&oacute;mo Triuno puede fortalecer tu plataforma, tu seguridad y tu crecimiento digital.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set(".hero-text-wrapper", { opacity: 1, visibility: "visible", y: 0, scale: 1, filter: "blur(0px)" });
      gsap.set(".main-card", { y: 80, scale: 0.94, opacity: 0, autoAlpha: 1 });
      ...
      scrollTl
        .to(".hero-text-wrapper", { scale: 1.15, filter: "blur(20px)", opacity: 0.18, ease: "power2.inOut", duration: 2 }, 0)
        .to(".bg-grid-theme", { scale: 1.15, filter: "blur(20px)", opacity: 0.2, ease: "power2.inOut", duration: 2 }, 0)
        .to(".main-card", { y: 0, scale: 1, opacity: 1, ease: "power3.out", duration: 2 }, 0)
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute inset-0 z-10 will-change-transform transform-style-3d">
        <HeroSection />
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/contacto#contact" className="btn-modern-light flex items-center justify-center px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
            <span className="text-xl font-bold leading-none tracking-tight">Agendar evaluaci&oacute;n</span>
          </a>
          <a href="/contacto" className="btn-modern-dark flex items-center justify-center px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-background">
            <span className="text-xl font-bold leading-none tracking-tight">Ver soluciones</span>
          </a>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        <div
          ref={mainCardRef}
          className="main-card premium-depth-card relative overflow-hidden gsap-reveal flex items-center justify-center pointer-events-auto w-[96vw] md:w-[94vw] h-[92vh] md:h-[88vh] rounded-[30px] md:rounded-[36px]"
        >
