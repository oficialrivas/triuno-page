...
export function CinematicHero({ 
  brandName = "Triuno",
  cardHeading = "Transformamos ideas en productos escalables.",
  cardDescription = <><span className="text-white font-semibold">Triuno</span> es un equipo senior de ingenieros y dise&ntilde;adores que construye software robusto, arquitectura cloud y productos digitales de alto impacto para startups y empresas en crecimiento.</>,
  metricValue = 50,
  metricLabel = "Proyectos",
  ctaHeading = "Hablemos de tu proyecto.",
  ctaDescription = "Agenda una llamada y descubre c\u00f3mo podemos escalar tu negocio con tecnolog\u00eda de vanguardia.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set(".main-card", { y: 220, autoAlpha: 1 });
      gsap.set(".mockup-scroll-wrapper", { y: 120, z: -150, rotationX: 18, rotationY: -10, autoAlpha: 1, scale: 0.85 });
      gsap.set([".card-left-text", ".card-right-text", ".floating-badge", ".phone-widget"], { autoAlpha: 0 });
  ...
  return (
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 pointer-events-auto will-change-transform">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        <p className="text-lg md:text-xl mb-12 max-w-xl mx-auto font-light leading-relaxed" style={{ color: "color-mix(in srgb, var(--color-foreground) 50%, transparent)" }}>
          {ctaDescription}
        </p>
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#contact" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <span className="text-lg font-bold">Agendar Llamada</span>
          </a>
          <a href="#about" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <span className="text-lg font-bold">Ver Casos de \u00c9xito</span>
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Tu Proyecto</span>
                        </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#d75012" strokeWidth="12" />
                        </svg>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-orange-500/20 to-orange-900/10 flex items-center justify-center border border-orange-400/30 shadow-inner">
                    <span className="text-base lg:text-xl drop-shadow-lg" aria-hidden="true">{"\u{1F525}"}</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">{metricValue}+ Proyectos</p>
                    <p className="text-orange-200/50 text-[10px] lg:text-xs font-medium">Portfolio activo</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner">
                    <span className="text-base lg:text-lg drop-shadow-lg" aria-hidden="true">{"\u{1F91D}"}</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Equipo Senior</p>
                    <p className="text-orange-200/50 text-[10px] lg:text-xs font-medium">Ingenieros expertos</p>
                  </div>
                </div>
            ...
            <div className="card-left-text order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="hidden md:block text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none" style={{ color: "color-mix(in srgb, #FFFFFF 50%, transparent)" }}>
                {cardDescription}
              </p>
            </div>
